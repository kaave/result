...
export declare type ErrValue = ValidUnion | Error | ReadonlyArray<ErrValue> | {
...
export declare type ExtractOk<T extends Result<OkValue, ErrValue>> = T extends Ok<infer P> ? Ok<P> : never;
export declare type ExtractErr<T extends Result<OkValue, ErrValue>> = T extends Err<infer P> ? Err<P> : never;
export declare type UnwrapOk<T extends Result<OkValue, ErrValue>> = T extends Ok<infer P> ? P : never;
export declare type UnwrapErr<T extends Result<OkValue, ErrValue>> = T extends Err<infer P> ? P : never;
...
export declare const isEveryOk: <T extends Result<OkValue, ErrValue>[]>(t: T) => t is ExtractOks<T>;
